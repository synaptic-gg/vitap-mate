...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 942828689;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        30 => wire__crate__api__vtop__paraser__wifi_portal__find_captivative_portal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        34 => wire__crate__api__vtop__paraser__parseattn__parse_attendance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        35 => wire__crate__api__vtop__paraser__parseattn__parse_full_attendance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        36 => wire__crate__api__vtop__paraser__parsemarks__parse_marks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        37 => wire__crate__api__vtop__paraser__parsesched__parse_schedule_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__vtop__paraser__parsett__parse_semid_timetable_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        39 => wire__crate__api__vtop__paraser__parsett__parse_timetable_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        40 => wire__crate__api__vtop_get_client__vtop_client_login_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        41 => wire__crate__api__vtop__vtop_config__vtop_config_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        43 => wire__crate__api__vtop__wifi__wifi_login_logout_hostel_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        31 => wire__crate__api__vtop_get_client__get_vtop_client_impl(ptr, rust_vec_len, data_len),
